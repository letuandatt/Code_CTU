...
WHERE h.TENHV='?? Gia B?o' AND h.NGAYSINH='2001-12-02'
      AND l.TENLOP='L?p 1' AND ll.TENLOAI='Ti?ng Anh c?n b?n';
...
FROM PHIEUTHU p JOIN LOP l ON p.MALOP = l.MALOP
                JOIN LOAILOP ll ON l.MALOAI = ll.MALOAI
WHERE l.TENLOP='L?p 2' AND ll.TENLOAI='Ti?ng Anh c?n b?n';
...
FROM HOCVIEN h JOIN PHIEUTHU p ON h.MAHV = p.MAHV
                ...
                JOIN LOAILOP ll ON l.MALOAI = ll.MALOAI
WHERE l.TENLOP='L?p 1' AND ll.TENLOAI='Ti?ng Anh c?n b?n';
...
FROM HOCVIEN h JOIN PHIEUTHU p ON h.MAHV = p.MAHV
                JOIN LOP l ON p.MALOP = l.MALOP
                JOIN LOAILOP ll ON l.MALOAI = ll.MALOAI
WHERE ll.TENLOAI='Ti?ng Anh c?n b?n' AND l.TENLOP='L?p 1';
